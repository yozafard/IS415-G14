```{r}
pacman::p_load(car, olsrr, corrplot, ggpubr, sf, spdep, GWmodel, tmap, tidyverse, gtsummary, tidygeocoder, GWmodel, SpatialML, tmap, rsample, Metrics)
...
gwRF_adaptive <- grf(formula = price_monthly ~ gender + size + building_year + prox_airport + prox_gereja + prox_kantorpos + prox_kesehatan + prox_masjid + prox_stasiunka + prox_vihara + pendidikan_within_med + pura_within_med,
                     ...
                     kernel="adaptive",
                     coords=coords_train)
write_rds(gwRF_adaptive, "gwrf/data/model/GWRF_model2.rds")
...
gwRF_pred <- predict.grf(gwRF_adaptive, 
                           ...
                           local.w=1,
                           global.w=0)
write_rds(gwRF_pred, "gwrf/data/GWRF_pred2.rds")
```
